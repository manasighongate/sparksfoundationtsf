    ...
    <h1>Customer List</h1> 
        ...
        <table > 
          ...
          <tr>
            ...
            <td><button type="button" class="btn btn-dark"><a href="userselesct.php?id= <?php echo $rows['Customer_id'] ;?> ">Transfer Money</a></button></td> 
          ...
          <footer>
    <p>&copy;2020-2023 Grip co-operative bank ltd</p>
  </footer>
</div>
</body>
</html>